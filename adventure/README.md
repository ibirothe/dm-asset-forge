...
Ein Aushang des Barons von Dornfels verspricht hohe Belohnung, wenn die Gruppe im alten Wachturm in den verfallenen Außenbereichen die verstummte Glocke wieder läuten lässt. Der sichtbare Fluch verdeckt Goldgier, heimliche Bergungsversuche und eine Glocke, die aus geraubtem Gold gegossen wurde. Der One-Shot ist lösbar, sobald weitere Bergungen gestoppt, die zentrale Wahrheit belastbar erkannt und die Zukunft der Glocke entschieden ist.

## Tischübersicht

Vor dem Spiel: [Session-Bereitschaft](60-session/readiness-report.md). Für die unmittelbare Leitung am Spieltisch: [DM cheat sheet](60-session/dm-cheat-sheet.md) und [Session run sheet](60-session/run-sheet.md).
...
Pfadabdeckung: [Global clue matrix](50-indexes/clue-matrix.md).
...
- Zielrahmen und sichere Kürzung: [One-shot scope and pacing](20-plot/overview.md#one-shot-scope-and-pacing) — Dornfelser Zeugnisse bündelbar, Zugangswege knapp abhandelbar.
...
- Spielbereit: Nein
- Wichtigste offene Frage: Regelbasis, Safety, Barrierefreiheit und reale Tischmaterialien im [Session-Preflight](00-input/session-preflight.md)
...
- [Session-Bereitschaft](60-session/readiness-report.md)
