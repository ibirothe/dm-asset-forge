...
participants: ["npc-rena-falk", "npc-borin-karrenschieber", "npc-nele-kerzenzieh", "npc-timo-netzflicker", "npc-liska-warenmass", "npc-gerolt-eisenfaust", "npc-baron-von-dornfels", "pc-justus-wertmueller", "pc-lars-sauertrahn", "pc-benedict-karlheist", "pc-tjorbe-hammerhand"]
...
Die Marktszene ist der konkrete Spielbeginn in Dornfels: Sie macht den Aushang des Barons, die Angst der Stadt, Einkaufsmöglichkeiten, erste Zeugen und mehrere Anschlusswege sichtbar, ohne den Auftrag oder eine Route vorzuschreiben.

## Entry state

Der Marktplatz ist voll genug, dass niemand allein mit seiner Angst ist. Der frisch befestigte [Aushang des Barons](../../objects/aushang-des-barons/object.md) hängt an einer gut sichtbaren Tafel; [Rena Falk](../../npcs/rena-falk/npc.md) hält Ordnung, während Händler weiterverkaufen und Gespräche beim Wort „Wachturm“ abbrechen. Die Gruppe kann als neugierige Reisende, angeworbene Helfer, Einkäufer oder bloße Beobachter in die Szene kommen.

## Participants and intentions

- [Rena Falk](../../npcs/rena-falk/npc.md): will Gedränge, Diebstahl und offene Panik verhindern; bei belastbaren Fragen lässt sie Befragungen zu, solange niemand den Markt aufwiegelt.
- [Borin Karrenschieber](../../npcs/borin-karrenschieber/npc.md): will arbeiten und nicht als Schwätzer gelten, kann aber Beobachtungen zu Werkzeugen, Kisten und nächtlichen Aufbrüchen liefern.
- [Nele Kerzenzieh](../../npcs/nele-kerzenzieh/npc.md): will Kerzen verkaufen und die Neumondangst überstehen; Freundlichkeit bringt präzise Einkaufsdetails hervor.
...
- [Tjorbe Hammerhand](../../../../40-global/player-characters/tjorbe-hammerhand/player-character.md): sucht Arbeit, kennt Jorek Malz und sieht in öffentlicher sowie geheimer Zusatzbelohnung eine große Gelegenheit; sein Schutzauftrag verpflichtet den Spieler zu keiner Loyalität.
...
Der Aushang verspricht einfache Belohnung für eine scheinbar klare Aufgabe, aber die Reaktionen des Markts widersprechen dieser Klarheit. Wer laut nach Goldwert, verschwundenen Leuten oder dem Baron fragt, zieht Aufmerksamkeit an; wer heimlich beobachtet, findet Spuren und Zeugen, riskiert aber Misstrauen der Wache oder Händler.
...
- Auftrag prüfen: Die Gruppe sammelt Aushang, Gerüchte und Zeugenaussagen; Dornfels bleibt offen für Bibliothek, Schänke, Baron oder weitere Marktgespräche.
- Ausrüstung priorisieren: Einkauf, Feilschen, Hilfe oder Diebstahl verändern Zeit, Sichtbarkeit und Verhältnis zu Rena, Liska oder Gerolt.
...
- Startimpuls: [Aushang des Barons](../../objects/aushang-des-barons/object.md)
- Vorbereitung: [Krämerauslage](../../objects/kraemerauslage/object.md), [Schmiedewaren und Schleifstein](../../objects/schmiedewaren-und-schleifstein/object.md)
