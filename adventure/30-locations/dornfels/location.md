...
Dornfels ist der öffentliche Einstieg und die betroffene Gemeinschaft: Hier werden Auftrag, Belohnung, Ausrüstung, Baron, Bibliothekslücken, Schänkenüberlieferung, Trauer und erste Widersprüche erreichbar.

## First impression

Eine geschäftige mittelgroße Stadt mit Marktständen, Herbergsrufen, Wachleuten und dem auffälligen Aushang des Barons. Die Angst vor dem Wachturm liegt unter der Alltagsroutine, weil der Turm zu den verfallenen Außenbereichen Dornfels' gehört und seine Schatten bis auf den Markt reichen.

## Sensory details

- Sicht: Steinernen Fassaden, Markttuch, Wachfarben des Barons und ein frisch befestigter Aushang.
- Klang: Händlerstimmen, gedämpfte Gespräche über Fluch und Belohnung, gelegentliches Schweigen beim Wort „Wachturm“.
- Geruch: Brot, nasses Leder, Rauch und staubige Archivluft nahe der Bibliothek.
- Körperliches Gefühl: Sichere Stadtoberfläche mit spürbarer sozialer Kontrolle.

## Access and boundaries

Der Marktplatz ist frei zugänglich. Die Bibliothek ist öffentlich oder mit geringem Aufwand erreichbar, sensible Aufzeichnungen können aber Aufmerksamkeit erregen. Direkter Zugang zum Baron hängt von Auftreten, Druck oder öffentlichem Aufsehen ab.
...
- Stadttor, Kanalkante und verfallene Außenbereiche: [Nolte am Tor](npcs/nolte-am-tor/npc.md), [Rena Falk](npcs/rena-falk/npc.md) und der Weg zu den [Zugängen zum Wachturm](../zugaenge-zum-wachturm/location.md) machen heimliche Bewegungen sichtbar.
...
- [Baron von Dornfels](npcs/baron-von-dornfels/npc.md)
- [Gerolt Eisenfaust](npcs/gerolt-eisenfaust/npc.md) hält teure Schmiedewaren und den Schleifstein unter Kontrolle.
- [Liska Warenmaß](npcs/liska-warenmass/npc.md) verkauft Vorräte und eine Regionalkarte.
- [Jorek Malz](npcs/jorek-malz/npc.md) lenkt Gespräche in der Schänke.
...
- [Herkunft der Glocke](information/herkunft-der-glocke/information.md)
- [Barons Auftrag ist irreführend](information/barons-auftrag-ist-irrefuehrend/information.md)
- [Verschwundene Bergungsleute](../alter-wachturm/information/verschwundene-bergungsleute/information.md) werden über Marktzeugen, [Mira Seilern](npcs/mira-seilern/npc.md) und verdeckte Anwerbungsspuren greifbar.
- [Verstummtes Seil](../alter-wachturm/information/verstummtes-seil/information.md) kann als Widerspruch zwischen Auftrag und technischer Ursache auffallen.
- [Fehlende Bücher der Plünderungszeit](information/fehlende-buecher-der-pluenderungszeit/information.md) grenzen die Epoche der Plünderung ein.
- [Überlieferung der Plünderung](information/ueberlieferung-der-pluenderung/information.md) bietet einen mündlichen Pfad zur alten Schuld.
- Die [Gefallenen von der Glocke](../../40-global/factions/gefallene-von-der-glocke/faction.md) sind in Dornfels nur über Gerüchte, Schänkenüberlieferung und die Folgen der Bergungsversuche präsent.
...
- Straßenränder, Waldweg und verfallene Außenbereiche führen direkt zu den [Zugängen zum Wachturm](../zugaenge-zum-wachturm/location.md).
- Die Kanalisation bietet einen verdeckten Zugang aus Dornfels über die [Zugänge zum Wachturm](../zugaenge-zum-wachturm/location.md), sofern die Gruppe ihn sucht oder aus lokalen Hinweisen erschließt.
