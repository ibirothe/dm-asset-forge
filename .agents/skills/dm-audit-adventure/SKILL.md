...
8. Report in the guide's order, including coverage for every active plot thread, every necessary conclusion, each scoped `player.md`, each relevant Visual, and every declared safe cut. If no finding exists, say so explicitly.
