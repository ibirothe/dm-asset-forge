...
13. Do not generate images during initialization. A requested Player Character may be created as a canonical draft, but do not create its `player.md` without presenting and obtaining approval for the exact release draft.
