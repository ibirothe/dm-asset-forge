...
1. Read `AGENTS.md` and the normative `docs/intake-workflow.md`, `docs/asset-katalog.md`, `docs/asset-authoring-guide.md`, `docs/metadaten-und-werte.md`, and `docs/beziehungen-und-speicherorte.md` before creating assets.
...
8. Build the restrained world and plot overviews. Create only the plot threads, locations, and assets necessary for the entry situation and central conflict, using `scripts/new_asset.py` for all catalog types. Keep them `draft` until they meet their type-specific Definition of Done.
