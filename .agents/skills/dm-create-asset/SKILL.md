...
8. Keep the full asset in exactly one canonical file. Add relative links from its owner, appearance locations, and index below `adventure/`. Update related assets wherever the relationship model requires a reciprocal link.
